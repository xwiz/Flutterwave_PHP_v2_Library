...
class qrEventHandler implements EventHandlerInterface{
    /**
...
class Qr {
    function __construct(){
        $this->qr = new Rave($_ENV['PUBLIC_KEY'], $_ENV['SECRET_KEY'], $_ENV['ENV']);
    }

    function accountCharge($array){
        //set the payment handler 
        $this->payment->eventHandler(new qrEventHandler)
